 ...
 */
function xoops_module_pre_update_xstyles(\XoopsModule $module)
{
...
function xoops_module_update_xstyles(\XoopsModule $module, $previousVersion = null)
{
    $moduleDirName      = basename(dirname(__DIR__));
    ...
    $helper       = Xstyles\Helper::getInstance();
    $utility      = new Xstyles\Utility();
    $configurator = new Xstyles\Common\Configurator();
